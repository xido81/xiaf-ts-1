	...
	return {
		...
		style: { //风格部分内容配置，这里主要配置loading和logo以及广告的部分内容
			...
			advertisement: { //广告相关的配置
				...
				videoForce: true,//视频广告是否强制播放结束
				videoVolume: 0.8,//视频音量
				skipButtonShow: false,//是否显示跳过广告按钮
				linkButtonShow: false,//是否显示广告链接按钮，如果选择显示，只有在提供了广告链接地址时才会显示
				muteButtonShow: false,//是否在视频广告时显示静音按钮
				closeButtonShow: true,//暂停时是否显示关闭广告按钮
				closeOtherButtonShow: true,//其它广告是否需要关闭广告按钮
				frontSkipButtonDelay: 5,//前置广告跳过广告按钮延时显示的时间，单位：秒
...
!(function() {
	...
	var ckplayer = function(obj) {
		...
		*/
		...
		this.contextMenu = [['设置', 'default', 'line'], ['静音', 'function', 'player.videoMute()'],['取消静音','function','player.videoEscMute()']];
		...
		this.playbackRateArr = [[0.5, '0.5倍速'], [1, '正常']/*, [1.25, '1.25倍'], [1.5, '1.5倍']*/, [2, '2倍速'], [4, '4倍速']];
		//全局变量：保存倍速
	...
	ckplayer.prototype = {
		...
		*/
		embed: function(c) {
			...
			if (window.location.href.substr(0, 7) == 'file://') {//如果是使用的file协议打网页则弹出提示
				alert('Please use the HTTP protocol to open the page(请使用HTTP协议打开网页)');
				return;
			}
			if (c == undefined || !c) {
		...
		*/
		...
		interFace: function() {
			...
			bOverColor = '#68A579'/*#0782F5*/; //按钮元素鼠标经过时的颜色
			...
			*/
			...
			this.css(loadProgressID, 'backgroundColor', '#687467' /*'#6F6F6F'*/);
			this.css(timeProgressID, 'backgroundColor', '#59B488'/*bOverColor*/);
			//时间进度按钮
			this.css(timeBOBGID, {
				width: '100%',
				height: '14px',
			...
			this.css(timeBOID, {
				...
				overflow: 'hidden',
				borderRadius: '50%',
				backgroundColor: /*'#59B488'*/ bBgColor,
				cursor: 'pointer',
				position: 'absolute',
				top: '0px',
				zIndex: '200'
			...
			this.css(timeBWID, {
				...
				borderRadius: '50%',
				position: 'absolute',
				backgroundColor: '#59B488' /*bOverColor*/,
				left: '3px',
				top: '3px'
			});
			this.css(timeTextID, {
			...
			this.css(volumeUpID, 'backgroundColor', '#59B488' /*bOverColor*/);
			...
			var cPlayOver = function(event) {
				...
				cPlay.fillStyle = '#68A579' /*bOverColor*/;
				cPlayFillRect();
			};
			...
			var cPauseOver = function(event) {
				...
				cPause.fillStyle = '#68A579' /*bOverColor*/;
				cPauseFillRect();
			};
			...
			var cFrontOver = function(event) {
				...
				cFront.fillStyle = '#68A579' /*bOverColor*/;
				cFrontFillRect();
			};
			...
			var cNextOver = function(event) {
				...
				cNext.fillStyle = '#68A579' /*bOverColor*/;
				cNextFillRect();
			};
			...
			var cFullOver = function() {
				...
				cFull.fillStyle = '#68A579' /*bOverColor*/;
				cFullFillRect();
			};
			...
			var cEscFullOver = function() {
				...
				cEscFull.fillStyle = '#68A579((' /*bOverColor*/;
				cEscFullFillRect();
			};
			...
			var cMuteOver = function() {
				...
				cMute.fillStyle = '#68A579' /*bOverColor*/;
				cMuteFillRect();
			};
			...
			var cEscMuteOver = function() {
				...
				cEscMute.fillStyle = '#68A579' /*bOverColor*/;
				cEscMuteFillRect();
			};
			...
			var cLoadingFillRect = function() {
				...
				grad2.addColorStop(1, '#0782F5'/*bOverColor*/);
			...
			var cPauseCenterOver = function() {
				...
				cPauseCenter.fillStyle = '#68A579' /*bOverColor*/;
				cPauseCenter.strokeStyle = '#68A579' /*bOverColor*/;
				cPauseCenterFillRect();
			};
			...
			var volumeBOOver = function() {
				thisTemp.css(volumeBOID, 'backgroundColor', '#59B488' /*bOverColor*/);
				thisTemp.css(volumeBWID, 'backgroundColor', bBgColor);
			};
			var volumeBOOut = function() {
				thisTemp.css(volumeBOID, 'backgroundColor', bBgColor);
				thisTemp.css(volumeBWID, 'backgroundColor', '#59B488' /*bOverColor*/);
			};
			this.addListenerInside('mouseover', volumeBOOver, this.getByElement(volumeBOID));
			this.addListenerInside('mouseout', volumeBOOut, this.getByElement(volumeBOID));
			//鼠标经过/离开进度按钮
			var timeBOOver = function() {
				thisTemp.css(timeBOID, 'backgroundColor', '#59B488' /*bOverColor*/);
				thisTemp.css(timeBWID, 'backgroundColor', bBgColor);
			};
			var timeBOOut = function() {
				thisTemp.css(timeBOID, 'backgroundColor', bBgColor);
				thisTemp.css(timeBWID, 'backgroundColor', '#59B488' /*bOverColor*/);
			};
